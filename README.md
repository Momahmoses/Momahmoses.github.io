...
**[momahmoses.github.io](https://momahmoses.github.io)**
...
| Section | Description |
|---------|-------------|
| Hero | Animated introduction with CTA to live GIS portfolio |
| About | Background, specialisation, and development philosophy |
| Tech Stack | Full technology badges across GIS, ML, Cloud, and Frontend |
| Projects | Featured project cards linking to GitHub repos |
| Contact | Email, GitHub, HuggingFace, and collaboration links |
...
```bash
git clone https://github.com/Momahmoses/Momahmoses.github.io.git
cd Momahmoses.github.io
